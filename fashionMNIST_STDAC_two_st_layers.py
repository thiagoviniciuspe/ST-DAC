...
os.environ['THEANO_FLAGS']='device=cuda0,gpuarray.preallocate=0.5,mode=FAST_RUN,floatX=float32,optimizer=fast_compile,dnn.enabled=True,exception_verbosity=high'
